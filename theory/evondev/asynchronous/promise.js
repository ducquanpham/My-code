...
//  3 methods used in promise
// .then (onFulfilled, onRejected) => resole
// .catch => bắt lỗi
// .finally => chạy khi mà error end resole
//
...
const timerTotal3 = Promise.allSettled([timer1, timer2, timer3]).then(
  (data) => {
